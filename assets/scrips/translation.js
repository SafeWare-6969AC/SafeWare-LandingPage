const translation ={
    ...
    features:{
        ...
        title: 'TU TRANQUILIDAD TAMBIÉN SE PUEDE MEDIR',
        ...
        cards:{
            ...
            automation:{
                ...
                subtitle: 'Ejecuta respuestas automaticas ante alertas, optimizando la seguridad y eficiencia del almacén',
            },
            security: {
                title: 'SEGURIDAD',
...
en : {
  ...
  contact: {
    ...
    description:
      "We’re here to help you protect what matters most. Write to us and discover how <b>SafeWare</b> can optimize security and maintenance in your facilities.",
    form: {
...
function translatePage(lang) {
  ...
  // Traduce placeholders en inputs y textareas
